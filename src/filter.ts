...
// Ported from EvoMap/evolver-claude-code-plugin `hooks/_filter.js` (MIT).
...
function timestampMs(entry: OutcomeEntry): number {
...
export function filterRelevant(entries: OutcomeEntry[]): OutcomeEntry[] {
